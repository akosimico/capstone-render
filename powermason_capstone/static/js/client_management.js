...
function loadEditClientData(clientId) {
    ...
    fetch(`/manage-client/api/clients/${clientId}/`)
        ...
        .then(data => {
            ...
            window.currentEditClientData = data;
            ...
            if (clientTypeSelect && data.client_type) {
                clientTypeSelect.value = data.client_type;
                const clientTypeMap = {'DC': 'Direct Client', 'GC': 'General Contractor'};
                const clientTypeName = clientTypeMap[data.client_type] || data.client_type;
            ...
            // Update Xero status
            updateEditXeroStatus(data);
            
            // Store and handle project types
            window.editClientProjectTypes = data.project_types || [];
